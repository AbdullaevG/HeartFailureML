...
from src.entities import TrainingPipelineParams, read_training_pipeline_params, report_text, report_table
...
def train_pipeline(training_pipeline_params: TrainingPipelineParams):
    ...
    model = save_model(model, training_pipeline_params.local_model_save_path, training_pipeline_params.model_s3_path)
    ...
    report_text(f"Model saved locally at {training_pipeline_params.local_model_save_path} and to minio: {training_pipeline_params.model_s3_path}!!!\n")
